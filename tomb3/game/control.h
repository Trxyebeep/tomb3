...
#define xLOS	( (long(__cdecl*)(GAME_VECTOR*, GAME_VECTOR*)) 0x00422700 )
#define zLOS	( (long(__cdecl*)(GAME_VECTOR*, GAME_VECTOR*)) 0x00422410 )
#define ClipTarget	( (long(__cdecl*)(GAME_VECTOR*, GAME_VECTOR*)) 0x004229F0 )
